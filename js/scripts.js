...
mr = (function (mr, $, window, document){
    ...
    mr.forms.submit = function(e){
        ...
        errorText = thisForm.attr('data-error') ? thisForm.attr('data-error') : "אנא מלא את כל השדות";
        successText = thisForm.attr('data-success') ? thisForm.attr('data-success') : "תודה על פנייתך. ניצור עמך קשר בהקדם!";
